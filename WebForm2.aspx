...
<body>
    <form id="form1" runat="server" class="auto-style1">
      <center>  <h1>EMPLOYEE SALARY DETAILS</h1></center>
       <div>
    <asp:GridView ID="grdEmployee" runat="server" AutoGenerateColumns="true"
      OnRowEditing="grdEmployee_RowEditing" OnRowDeleting="grdEmployee_RowDeleting"
       CssClass="auto-style5" DataKeyNames="EmployeeId" OnRowCancelingEdit="grdEmployee_RowCancelingEdit" OnRowUpdating="grdEmployee_RowUpdating" Width="878px">
      <Columns>
